Public Class ButtonHelper
    ...
    End Sub
    Public Shared ReadOnly DialogResultProperty As DependencyProperty = DependencyProperty.RegisterAttached("DialogResult", GetType(System.Nullable(Of Boolean)), GetType(ButtonHelper), New UIPropertyMetadata() With {.PropertyChangedCallback = Sub(obj, e)
